...
/**
 * Alternate version of the Timer class for use when logging. Syncronizes the
 * timestamp on the real robot and uses the logged timestamp in the simulator.
 */
public class LoggedTimer {
  ...
  private double getMsClock() {
    return Logger.getInstance().getTimestamp() * 0.001;
  }
